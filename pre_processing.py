...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='whisper-V1.0.0')
    ...
    parser.add_argument('--json_record', default=None, type=str, help='The json file that has been written')
