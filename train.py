...
if __name__ == '__main__':
    ...
    parser.add_argument('--catalog_json', default='txt*train.txt', help='txt<catalog_json or dir<catalog_json')
    parser.add_argument('--path_to_whisper_hf', default='/source/DataRepository/whisper-hf_history', type=str,
                        help='Local Configuration')
    parser.add_argument('--model_path', default='/source/DataRepository/whisper_hf_old', type=str,
                        help='Local Configuration')
